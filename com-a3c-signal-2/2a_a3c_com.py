...
def main():
    ...
    if not os.path.exists(dir+'/a1_A3c'):
        os.makedirs(dir+'/a1_A3c')
    if not os.path.exists(dir+'/a2_A3c'):
        os.makedirs(dir+'/a2_A3c')
    ...
    if testing:
        ...
        logging_config(logging, dir+'/log', 'signal_2_com_tmax_' + str(args.t_max))
    ...
    if testing:
        ...
        a1_A3c_file = dir+'/a1_A3c/network-dqn_mx0019.params'
        a2_A3c_file = dir+'/a2_A3c/network-dqn_mx0019.params'
        a1_comNet_file =dir+'/a1_comNet/network-dqn_mx0019.params'
        a2_comNet_file = dir+'/a2_comNet/network-dqn_mx0019.params'

    action_num = 4
    a1_A3c = A3c(state_dim=74, signal_num=2, act_space=action_num, config=config)
    a2_A3c = A3c(state_dim=74, signal_num=2, act_space=action_num, config=config)

    a1_comNet = ComNet(state_dim=74, signal_num=2, config=config)
    a2_comNet = ComNet(state_dim=74, signal_num=2, config=config)
    ...
    if continue_training:
        ...
        a1_A3c.model.load_params(dir + '/a1_A3c/network-dqn_mx%04d.params' % (start_epoch - 1))
        a2_A3c.model.load_params(dir + '/a2_A3c/network-dqn_mx%04d.params' % (start_epoch - 1))
        a1_comNet.model.load_params(dir + '/a1_comNet/network-dqn_mx%04d.params' % (start_epoch - 1))
        a2_comNet.model.load_params(dir + '/a2_comNet/network-dqn_mx%04d.params' % (start_epoch - 1))
    ...
    for epoch in epoch_range:
        ...
        a1_A3c.model.save_params(dir+'/a1_A3c/network-dqn_mx%04d.params' % epoch)
        a2_A3c.model.save_params(dir+'/a2_A3c/network-dqn_mx%04d.params' % epoch)
        a1_comNet.model.save_params(dir+'/a1_comNet/network-dqn_mx%04d.params' % epoch)
        a2_comNet.model.save_params(dir+'/a2_comNet/network-dqn_mx%04d.params' % epoch)
