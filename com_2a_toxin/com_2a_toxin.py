...
def main():
    ...
    parser.add_argument('--continue-training', type=bool, default=True)
    parser.add_argument('--epoch-num', type=int, default=20)
    parser.add_argument('--start_epoch', type=int, default=20)
    parser.add_argument('--testing_epoch', type=int, default=19)
    ...
    # Init networks
    a1_AC = ActorCritic(state_dim=74, signal_num=4, act_space=action_num, dir=dir, folder='a1_AC', config=config)
    a2_AC = ActorCritic(state_dim=74, signal_num=4, act_space=action_num, dir=dir, folder='a2_AC', config=config)

    a1_CDPG = CDPG(state_dim=74, signal_num=4, dir=dir, folder='a1_CDPG', config=config)
    a2_CDPG = CDPG(state_dim=74, signal_num=4, dir=dir, folder='a2_CDPG', config=config)
    ...
    if testing:
        ...
        a1_CDPG.model.load_params(testing_epoch)
        a2_CDPG.model.load_params(testing_epoch)
