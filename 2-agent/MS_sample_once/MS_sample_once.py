    ...
    for epoch in epoch_range:
        ...
        while steps_left > 0:
            ...
            while not env.game_over():
                ...
                replay_memory1.append(next_ob[1], action2, reward[1], terminal_flag)
                ...
                if total_steps % update_interval == 0 and replay_memory1.size > replay_start_size:
                    ...
                    a2_target32.model.forward(mx.io.DataBatch([nd.array(nextstate_batch1, ctx=q_ctx)], []))
                    Qvalue2 = a2_target32.model.get_outputs()[0]

                    y_batch2 = reward_batch1 + nd.choose_element_0index(Qvalue2, nd.argmax_channel(Qvalue2)) * (
                        1.0 - terminate_flags1) * discount

                    Qnet2.model.forward(mx.io.DataBatch([state_batch1, actions_batch1, y_batch2],
                                                        []), is_train=True)
                    ...
                    if training_steps % 10 == 0:
                        ...
                        loss2 = 0.5 * nd.square(
                            nd.choose_element_0index(Qnet2.model.get_outputs()[0], actions_batch1) - y_batch1)
