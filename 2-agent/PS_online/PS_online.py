...
def main():
    ...
    for epoch in epoch_range:
        ...
        while steps_left > 0:
            ...
            while not all_done:
                _, _, step_value1, _, _, step_policy1, step_policy2 = a1_AC.forward(step_ob1, is_train=False)
                ...
                if t == t_max:
                    ...
                    extra_value1 = a1_AC.forward(step_ob1, is_train=False)[2]
                    ...
                    _, _, episode_value1, _, _, episode_policy1, episode_policy2 = a1_AC.forward(env_ob1,
                                                                                                 is_train=True)
                    a1_AC.model.backward(out_grads=[neg_advs1, neg_advs2, value_grads1])
                    a1_AC.model.update()
