...
class HunterWorld(PyGameWrapper):
    ...
    def _fix_postion(self):
        pos_list = [[0.45, 0.45], [0.65, 0.45], [0.95, 0.85],
                    [0.25, 0.45], [0.95, 0.95], [0.95, 0.95], [0.95, 0.85], [0.95, 0.95],
                    [0.95, 0.95], [0.75, 0.95], [0.75, 0.95], [0.95, 0.95], [0.05, 0.05],
                    [0.96, 0.84], [0.97, 0.92], [0.98, 0.92], [0.95, 0.96], [0.98, 0.95]]
...
if __name__ == "__main__":
    ...
    pygame.init()
    game = HunterWorld(width=1024, height=1024, num_preys=10, num_hunters=2, draw=True)
